export const metadata = {
  ...
  description:
    'Process of compiling a C++ project and CMake.',
  slug: 'cpp-build-system-cmake',
  date: '2024-01-15',
  type: 'Post',
  language: 'Mandarin',
  keywords: 'c++, build system',
  enabled: true,
  readingTime: '8',
};
...
1. Read Source file (`main.cpp`)
2. [ Preprocessor ] → preprocessed file (`main.ii`)
3. [ Compiler ] → assembly file (`main.s`)
4. [ Assembler ] → object file   (`main.o`)
5. [ Linker ] (with some libraries if needed)
6. executable (`a.out`   or `main`)
