...
description: Process of compiling a C++ project, and the advantage of using CMake.
...
Compiler 在把 source file (e.g. main.cpp) 轉換成 executable (e.g. a.out) 的過程中需要很多個步驟，但初學時通常用一個指令就足夠了，因為compiler 都會幫你處理好所有的事情。
...
### 4. Link main application to libraries
